...
typedef struct
{
    ...
    int32_t m_value;
    OpCode m_opCode;
    int32_t m_objectEntityIndex;
    EnemyType m_hintEnemyType;
    bool m_isAlways;
}
MissionCondition;

enum LevelType : int8_t
{
    LEVELTYPE_NONE = 0,
    LEVELTYPE_1 = 1,
    LEVELTYPE_2 = 2,
...
typedef struct
{
    bool m_enableMission;
    TitleKind m_title;
    int32_t m_stageListPos;
    FinishType m_finishType;
    int32_t m_timeLimitSec;
    MissionCondition m_conditions[3];
    uint32_t m_rankTimes[4];
    int32_t m_rankRings[4];
    LevelType m_levelType;
    StageKind m_dispStageKind;
    cstring m_debugDescription;
    bool m_enableTails;
    bool m_isMirroring;
    PlayerType m_playerType;
    bool m_enableAttackChain;
}
MissionData;

typedef struct
{
    int32_t m_coinCounts[4];
}
MissionReward;

typedef struct
{
    MissionReward m_rewards[6];
    int32_t m_firstClearBonus;
}
MissionRewardData;

typedef struct
{
    MissionData m_missionData[112];
    MissionRewardData m_missionRewardData;
}
MissionInfo;
