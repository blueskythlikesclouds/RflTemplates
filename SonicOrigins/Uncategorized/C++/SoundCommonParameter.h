...
typedef struct
{
    ...
    BGMVolumeChangeInfo breakPortalStart;
    BGMVolumeChangeInfo breakPortalEnd;
    BGMVolumeChangeInfo getEmeraldStart;
    BGMVolumeChangeInfo getEmeraldEnd;
    BGMVolumeChangeInfo getEmeraldEndBoss;
    BGMVolumeChangeInfo bossAreaIn;
    BGMVolumeChangeInfo bossAreaOut;
...
typedef struct
{
    ...
    BGMInfo changeBgmInfo[99];
    BGMTransitInfo transitBgmInfo[99];
}
