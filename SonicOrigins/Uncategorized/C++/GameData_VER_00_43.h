...
enum GameModeData_VER_00_43_Status : int8_t
{
    STATUS_NONE = 0
};
...
typedef struct
{
    GameModeData_VER_00_43_Status status;
    ...
    uint8_t reserved[4];
    uint32_t flags;
    GamePlayData gamePlayData[51];
    LegacyModeData legacyModeData[37];
...
typedef struct
{
    CheckPointSave checkPointSave[48];
}
...
typedef struct
{
    TutorialParam_VER_00_43 params[32];
}
TutorialData_VER_00_43;

typedef struct
{
    uint32_t holdValue[125];
}
...
typedef struct
{
    HoldValues_VER_00_43 holdValues[23];
    SendFlags_VER_00_43 sendFlags[23];
}
...
typedef struct
{
    ...
    GameModeData_VER_00_43 gameModeData;
    CollectionData collection;
    CheckPointSaveData_VER_00_43 checkPointSaveData;
    AnywareSaveData_VER_00_43 anywareSaveData;
    StatsContainerData stats;
    MissionSaveData mission;
    StageClearData_VER_00_43 stageClear;
    MuseumData museumData;
    TutorialData_VER_00_43 tutorialData;
    PlayReportData_VER_00_43 playreportData;
