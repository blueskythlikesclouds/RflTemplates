...
{
    [FieldOffset(0)]  public array initPositions;
...
{
    [FieldOffset(0)]    public unsafe fixed byte /* BossRifleBeastAttackData[16] */ _attackDatas[896];

    public unsafe BossRifleBeastAttackData* attackDatas
    {
        get
        {
            fixed (byte* p_attackDatas = _attackDatas)
                return (BossRifleBeastAttackData*)p_attackDatas;
        }
    }

    [FieldOffset(896)]  public unsafe fixed byte /* BossRifleBeastAttackData[2] */ _bitBreakAttackDatas[112];

    public unsafe BossRifleBeastAttackData* bitBreakAttackDatas
    {
        get
        {
            fixed (byte* p_bitBreakAttackDatas = _bitBreakAttackDatas)
                return (BossRifleBeastAttackData*)p_bitBreakAttackDatas;
        }
    }
...
public struct BossRifleBeastPhaseParam
{
    ...
    [FieldOffset(16)]   public unsafe fixed byte /* BossRifleBeastAttackPatternParam[4] */ _patterns[4064];

    public unsafe BossRifleBeastAttackPatternParam* patterns
    {
        get
        {
            fixed (byte* p_patterns = _patterns)
                return (BossRifleBeastAttackPatternParam*)p_patterns;
        }
    }
...
public struct BossRifleBeastBattleAttackHomingLaserAttackParam
{
    ...
    [FieldOffset(136)] public unsafe fixed byte /* BossRifleBeastBattleAttackHomingLaserShotPoint[32] */ _points[384];

    public unsafe BossRifleBeastBattleAttackHomingLaserShotPoint* points
    {
        get
        {
            fixed (byte* p_points = _points)
                return (BossRifleBeastBattleAttackHomingLaserShotPoint*)p_points;
        }
    }
...
public struct BossRifleBeastBattleAttackHandLaser
{
    ...
    [FieldOffset(32)]  public unsafe fixed byte /* BossRifleBeastBattleAttackHandLaserPatternParam[4] */ _handLeftPatterns[320];

    public unsafe BossRifleBeastBattleAttackHandLaserPatternParam* handLeftPatterns
    {
        get
        {
            fixed (byte* p_handLeftPatterns = _handLeftPatterns)
                return (BossRifleBeastBattleAttackHandLaserPatternParam*)p_handLeftPatterns;
        }
    }

    [FieldOffset(352)] public unsafe fixed byte /* BossRifleBeastBattleAttackHandLaserPatternParam[4] */ _handRightPatterns[320];

    public unsafe BossRifleBeastBattleAttackHandLaserPatternParam* handRightPatterns
    {
        get
        {
            fixed (byte* p_handRightPatterns = _handRightPatterns)
                return (BossRifleBeastBattleAttackHandLaserPatternParam*)p_handRightPatterns;
        }
    }
}
...
{
    [FieldOffset(0)]  public unsafe fixed byte /* BossRifleBeastBattleZoomCamera[2] */ _normalCamera[80];
    ...
    [FieldOffset(80)] public unsafe fixed byte /* BossRifleBeastBattleZoomCamera[2] */ _flyCamera[80];

    public unsafe BossRifleBeastBattleZoomCamera* flyCamera
    {
        get
        {
            fixed (byte* p_flyCamera = _flyCamera)
                return (BossRifleBeastBattleZoomCamera*)p_flyCamera;
        }
    }
}
...
{
    [FieldOffset(0)]     public unsafe fixed byte /* BossRifleBeastPhaseParam[4] */ _giantPhaseParams[16384];

    public unsafe BossRifleBeastPhaseParam* giantPhaseParams
    {
        get
        {
            fixed (byte* p_giantPhaseParams = _giantPhaseParams)
                return (BossRifleBeastPhaseParam*)p_giantPhaseParams;
        }
    }

    [FieldOffset(16384)] public unsafe fixed byte /* BossRifleBeastPhaseAttackActionParam[16] */ _actionParams[1152];
    ...
    [FieldOffset(17536)] public unsafe fixed byte /* BossRifleBeastBattleParam_ActionType[20] */ _immediateActions[20];

    public unsafe BossRifleBeastBattleParam_ActionType* immediateActions
    {
        get
        {
            fixed (byte* p_immediateActions = _immediateActions)
                return (BossRifleBeastBattleParam_ActionType*)p_immediateActions;
        }
    }
