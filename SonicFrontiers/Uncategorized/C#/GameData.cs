    ...
    public enum SequenceDeprecated : sbyte
{
    ...
    {
        [FieldOffset(0)]    public WorldFlagData worldData;
        [FieldOffset(7168)] public ExtraFlagData extraData;
    }

    [StructLayout(LayoutKind.Explicit, Size = 12)]
    public struct ScoreAndRnakData
    {
        [FieldOffset(0)] public uint hightScore;
        [FieldOffset(4)] public ushort rank;
        [FieldOffset(6)] public ushort padding0;
    ...
    public enum WeatherBlockData_Status : sbyte
{
    ...
    public struct GameData
    {
        ...
        [FieldOffset(45888)]  public ExtraFlagContainerData extraFlags;
        [FieldOffset(56640)]  public ActionChainStruct actionChain;
        [FieldOffset(59040)]  public ReservedData reserved;
